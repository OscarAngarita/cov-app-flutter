...
void main() async {
  //Used to access the binary messenger before `runApp()` has been called
  ...
  //Make shared preferences available synchronously and then pass it to MyApp as an argument. This needs 'binary messeger'
